...
public class MainActivity extends Activity {
    ...
    public void createShortcut(Intent intent){
        ...
        if (shortcutLabel!=null && shortIntent!=null && icon!=null){
            ...
            LinearLayout ll = (LinearLayout) li.inflate(R.layout.drawable_item, null);
    ...
    public void deleteShortcut(){
        ...
        ComponentName componentToDisable =
                new ComponentName("com.example.darklord.blinklauncher",
                        "com.example.darklord.blinklauncher.MainActivity");
